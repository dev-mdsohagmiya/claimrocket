...
const Hero = () => {
  ...
  return (
    <div
      className={`min-h-screen bg-cover bg-center relative  bg-black h-[1700px] md:h-[1200px]`}
    >
      {/* Background Image  */}
      <Image
      ...
      />
      <div className="absolute inset-0 flex flex-col items-center top-20 md:top-48 md:mx-[130px] mx-[45px]">
        {/* Hero upper part  */}
        <div className="text-white  grid grid-cols-12 mb-14">
          <div className="col-span-12 md:col-span-6 ">
            ...
            <div>
              <p className="text-xl tracking-normal leading-9 font-light">
        ...
        {/* Hero Lower part */}
        <div
          className="text-white flex flex-col md:flex-row justify-center   gap-8 items-end  "
          data-aos="zoom-in"
        >
