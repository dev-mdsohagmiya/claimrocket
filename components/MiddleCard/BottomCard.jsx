  ...
  return (
    <div className="bg-black md:px-[130px] px-[45px] text-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 p-5 md:p-16 items-center justify-center lg:mx-[45px]">
          ...
          <div>
            <p>
              ...
              coupled with free initial consultations, underscores our
              commitment to your cause. With your injury as our top priority, we
              navigate the legal complexities while you focus on healing. Join
              the Claim Rocket family today and experience our powerful,
              rocket-speed representation.
            </p>
          </div>
        </div>
      </div>
